...
(function () {
    ...
    function CreateResult() {
        ...
        newDiv.style.width = "90%";  // Set the width of the parent div to 100%
        newDiv.style.margin = "0 auto";  // Center the div

        Result = document.createElement("textarea");
        Result.setAttribute("readonly", "true");
        Result.setAttribute("rows", 50);
        Result.setAttribute("cols", 10);  // Set a smaller value for cols
        Result.style.width = "100%";  // Set the width of the textarea to 100%
        Result.style.margin = "0 auto";  // Center the textarea
