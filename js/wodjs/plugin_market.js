...
// @namespace      UncleKang
// @version        1.2
// @include        https://*.world-of-dungeons.*/wod/spiel/hero//csvexport.php*
// @include        https://*.world-of-dungeons.*/wod/spiel/hero/items.php*
// @downloadURL https://update.greasyfork.org/scripts/3797/%5Bwod%5D%E5%B0%8F%E5%B8%82%E5%9C%BA%EF%BC%88%E5%9B%A2%E5%95%86%E5%88%A9%E5%99%A8%EF%BC%89Ver%2012.user.js
// @updateURL https://update.greasyfork.org/scripts/3797/%5Bwod%5D%E5%B0%8F%E5%B8%82%E5%9C%BA%EF%BC%88%E5%9B%A2%E5%95%86%E5%88%A9%E5%99%A8%EF%BC%89Ver%2012.meta.js
// ==/UserScript==
...
(function () {
	...
	function Main() {
		if (/\/wod\/spiel\/hero\/\/csvexport.php?.*&is_tomy=1/.test(document.URL)) {
			...
			chrome.runtime.sendMessage({ action: 'generateLibData', data: Pre.innerHTML }, response => {
				window.close();
			});
			/*
	...
	function ConvertToBB(items) {
		...
		var totalRet = "\r\n[size=20]" + localVars.titleTreasury + "[/size][hr]";
